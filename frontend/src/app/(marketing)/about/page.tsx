  ...
  return (
    <>
      {loading ? (
        ...
        <div className="min-h-screen mt-8 bg-white text-gray-900 px-6 py-16">
            ...
            <section className="mb-16">
              ...
              <div className="grid sm:grid-cols-3 gap-8">
                {[
                  {
                    name: 'Aarav Sharma',
                    feedback: 'BlogVerse helped me grow my audience and connect with amazing writers across the world.',
                  },
                  {
                    name: 'Zoya Khan',
                    feedback: 'As a creative, BlogVerse gave me the platform to express and evolve my voice with a community that listens.',
                  },
                  {
                    name: 'Rishi Patel',
                    feedback: 'The interface is so intuitive and clean. I love sharing my thoughts here — it feels like home.',
                  },
                  ...
                  >
                    <div className="text-indigo-600 text-4xl mb-3 font-serif">“</div>
